...
\noindent\textbf{Özet} Docker Compose dosyaları yalnızca insanlar tarafından değil, dağıtım
...
\noindent\textbf{Abstract} Docker Compose files are increasingly modified programmatically by

...
gerçekleştiren ComposeMorph'u sunuyoruz. 647 gerçek dünya ve 38 kontrollü 
Compose dosyasından oluşan veri kümesi üzerinde gerçekleştirilen yedi 
deneyle; doğruluk, yapı koruma, değişikliklerin yerelliği, ileriye dönük 
uyumluluk ve performans değerlendirildi. Dosyalara eklenen 802 bilinmeyen
...
alanlarını koruyamamıştır. Tüm veri kümeleri, betikler ve ham sonuçlar 
yeniden üretilebilirlik gözetilerek yayımlanmıştır.
\end{abstract}
